        ...
        body: ListView(
          ...
          children: <Widget>[
              ...
              children: <Widget>[
                ...
                Row(
                  children: <Widget>[
                    ...
                    Text(
                      'Éste es tu nombre de usuario, tus amigos pueden\nencontrarte fácilmente dentro de la aplicación con él.',
                      style: TextStyle(
                        fontSize: 12,
            ...
            !controller.usuario.monedasFree
              ...
              ? RaisedButton(
                  child: Text('Reset Rewards'),
                  onPressed: () async {
                   await Firestore.instance.collection('reset').document('reset').updateData({
                     'reset' : true,
                   });
                  },
                )
